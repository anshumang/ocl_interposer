...
static int initialize(int use_gpu)
{
	...
	clGetDeviceIDs(platform_id, CL_DEVICE_TYPE_GPU, 0, NULL, (cl_uint *)&num_devices);
	printf("num_devices = %d\n", num_devices);
	...
	//if( result != CL_SUCCESS ) { printf("ERROR: clGetContextInfo() failed\n"); return -1; }
 	result = clGetDeviceIDs(platform_id, CL_DEVICE_TYPE_GPU, num_devices, device_list, NULL);	
